...
public class ProductController {
    ...
    @Autowired
    private AddProductQuantity addProductQuantity;
    @Autowired
    ...
    */
    @PutMapping
    public ResponseEntity<Void> addProductQuantity(@Valid @NotNull @RequestBody ProductDTO body) {
        addProductQuantity.accept(body);
